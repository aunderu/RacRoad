...
class Data {
  ...
  Map<String, dynamic> toJson() => {
        "sos":
            sos == null ? [] : List<dynamic>.from(sos!.map((x) => x.toJson())),
      };
}
...
class So {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "tu_step2": tuStep2?.toIso8601String(),
        "tu_step3": tuStep3?.toIso8601String(),
        "tu_step4": tuStep4?.toIso8601String(),
        "tu_step5": tuStep5?.toIso8601String(),
        "tu_step6": tuStep6?.toIso8601String(),
        "tu_step7": tuStep7?.toIso8601String(),
        "tu_step8": tuStep8?.toIso8601String(),
        "tu_sc": tuSc?.toIso8601String(),
        "tu_price2": tuPrice2?.toIso8601String(),
        "tu_user_deal2": tuUserDeal2?.toIso8601String(),
      };
}
