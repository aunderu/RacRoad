...
ClubPostModel clubPostModelFromJson(String str) =>
    ClubPostModel.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        myClubPost: List<MyClubPost>.from(
            json["my_club_post"].map((x) => MyClubPost.fromJson(x))),
      );
